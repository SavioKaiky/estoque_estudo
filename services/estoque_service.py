...
============================
REGRAS DE NEGÓCIO de movimentação de insumos.

CORREÇÕES aplicadas:
  - Bug dupla soma corrigido (da versão anterior)
  - Não atualiza mais insumo.estoque_atual manualmente —
    o saldo é calculado via property a partir das movimentações
  - Usa db.session.get() em vez de Insumo.query.get() (depreciado)
"""
